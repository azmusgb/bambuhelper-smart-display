...
static void sendWorkshopMediaStatus(int httpCode = 200) {
  ...
  const PrinterSlot& printer = displayedPrinter();
  doc["printerCameraObserved"] = printer.state.ipcamSeen;
  doc["printerLiveviewPreview"] = printer.state.liveviewPreview;
  doc["printerRtspEnabled"] = printer.state.rtspEnabled;
  doc["printerCameraResolution"] = printer.state.cameraResolution;
  doc["printerBrtcEnabled"] = printer.state.brtcServiceEnabled;
  doc["printerTutkEnabled"] = printer.state.tutkServiceEnabled;
