...
def main() -> None:
    ...
    require("deterministic output guard", safety, [
        ...
        "urgentSnapshotEvidenceTerms",
        "urgentUserEvidencePhrases",
        "userQuestion: String = \"\"",
        "answer.severity == .critical && !hasUrgentEvidence(snapshot, userQuestion: userQuestion)",
    ...
    require("executable safety tests", tests, [
        ...
        "testCommandSentExecutionClaimIsWithheld",
        "testCriticalDowngradesWithoutUrgentEvidence",
        "testCriticalCanRemainWhenSnapshotContainsUrgentEvidence",
        "testCriticalCanRemainForDirectUserHazardReport",
        "testHypotheticalSmokeQuestionDoesNotGrantCriticalSeverity",
