...
def main() -> int:
    ...
    require(evidence, ("OS12_TRAILING_COL_W", "trailingX", "leftW"), "evidence row")
    ...
    require(toggle, ("OS12_ROW_INSET_X", "controlW=66", "36"), "toggle geometry")
    require(stepper, ("buttonW=46", "buttonH=44", "OS12_ACTION_GAP"), "stepper geometry")

    print("PASS: OS12 480x320 geometry uses canonical margins, rows, action bars, and aligned evidence columns")
    return 0
